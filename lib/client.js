...
var CSS =
  ...
  ".pmb-spacer{flex:1}" +
  ".pmb-panel{position:fixed;top:0;right:0;bottom:0;width:min(1180px,96vw);max-width:100vw;display:flex;flex-direction:column;background:var(--dsw-alias-bg-layer-1,#1c1f26);border-left:1px solid var(--dsw-alias-border-l1,#3a3f47);box-shadow:var(--dsw-alias-shadow-lv3,0 8px 40px rgba(0,0,0,.5));pointer-events:auto;z-index:1200}" +
  ...
  ".pmb-sub{font-size:12px;color:var(--dsw-alias-label-secondary,#8b929e)}" +
  ...
  ".pmb-none{font-size:12px;color:var(--dsw-alias-label-secondary,#8b929e);padding:16px 2px;text-align:center}" +
  ...
  ".pmb-stat .k{font-size:11px;color:var(--dsw-alias-label-secondary,#8b929e)}" +
  ".pmb-stat .v{font-size:18px;font-weight:600;color:var(--dsw-alias-label-primary,#e6e8eb);font-variant-numeric:tabular-nums}" +
  ".pmb-stat .u{font-size:11px;color:var(--dsw-alias-label-secondary,#8b929e)}" +
  ...
  ".pmb-axis .lbl{width:230px;flex:none;padding:0 10px;display:flex;align-items:center;font-size:11px;color:var(--dsw-alias-label-secondary,#8b929e);border-right:1px solid var(--dsw-alias-border-l1,#3a3f47)}" +
  ".pmb-axis .ticks{flex:1;position:relative}" +
  ".pmb-axis .tick{position:absolute;top:0;bottom:0;border-left:1px solid var(--dsw-alias-border-l1,#3a3f47);font-size:10px;color:var(--dsw-alias-label-secondary,#8b929e);padding-left:4px;line-height:26px;white-space:nowrap}" +
  ...
  ".pmb-lane-m{display:flex;gap:5px;align-items:center;font-size:10.5px;color:var(--dsw-alias-label-secondary,#8b929e);flex-wrap:wrap}" +
  ...
  ".pmb-task-id{font-size:11px;font-family:ui-monospace,Consolas,monospace;color:var(--dsw-alias-label-secondary,#8b929e)}" +
  ...
  ".pmb-phase{display:inline-flex;align-items:center;gap:4px;padding:1px 7px;border-radius:5px;font-size:11px;border:1px solid var(--dsw-alias-border-l1,#3a3f47);color:var(--dsw-alias-label-secondary,#8b929e)}" +
  ...
  ".pmb-legend{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:10px;font-size:11px;color:var(--dsw-alias-label-secondary,#8b929e);align-items:center}" +
  ...
  ".pmb-table th{color:var(--dsw-alias-label-secondary,#8b929e);font-weight:500;font-size:11px}" +
  ...
  /* settings section (rendered inside the DSH settings dialog, not the drawer) */
  ...
  ".pmb-settings-section .pmb-legend{font-size:12px;line-height:1.6;margin:0}" +
  ".pmb-settings-section .pmb-res{padding:12px 14px;gap:8px}" +
  ".pmb-settings-section .pmb-btn{height:26px;font-size:12px}" +
  ".pmb-settings-section select.pmb-btn{padding:0 6px;color:var(--dsw-alias-label-primary,#e6e8eb)}";
  ...
  factory: function (require) {
    ...
    function ExpertModelForm(props) {
      try {
        ...
        return React.createElement(
          "div",
          { className: "pmb-none", style: { color: COLORS.failed } },
      ...
      children.push(
        React.createElement(
          ...
          open && catalog === null
            ? React.createElement(
                "div",
                { className: "pmb-task-body", style: { color: COLORS.planned } },
            ...
            ? React.createElement(
                ...
                React.createElement(
                  "button",
                  {
                    ...
                    disabled: view.busy || !shown.provider || !shown.model,
                    onClick: function () {
                      setNote(null);
                      setError(null);
                      manage({
